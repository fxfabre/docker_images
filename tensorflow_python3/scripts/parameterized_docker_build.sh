...
TF_DOCKER_BUILD_TYPE=${TF_DOCKER_BUILD_TYPE,,}
TF_DOCKER_BUILD_IS_DEVEL=${TF_DOCKER_BUILD_IS_DEVEL,,}
TF_DOCKER_BUILD_PYTHON_VERSION=${TF_DOCKER_BUILD_PYTHON_VERSION,,}
TF_DOCKER_BUILD_OPTIONS=${TF_DOCKER_BUILD_OPTIONS:-OPT}
